  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: "OneBite Team for  cybersecurity solutions have transformed our security posture. Their AI-powered threat detection identified vulnerabilities that our previous security audits missed completely.",
    ...
    },
    {
      ...
      content: "Implementination OneBite  security framework has been a game-changer for our organization. Their team's expertise and cutting-edge technology have given us confidence in our digital infrastructure.",
    ...
    },
    {
      ...
      content: "The penetration testing onducted by OneBite was the most thorough we've ever experienced. They identified critical vulnerabilities that could have resulted in significant data breaches.",
