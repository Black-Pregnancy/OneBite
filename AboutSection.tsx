          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-gray-300 mb-4 terminal-text">
                OneBite Team was founded with a clear objective: to provide unparalleled cybersecurity solutions in an increasingly hostile digital landscape.
              </p>
